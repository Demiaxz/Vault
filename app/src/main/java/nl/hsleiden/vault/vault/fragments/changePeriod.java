 ...
 */
public class changePeriod extends DialogFragment {
    ...
    public changePeriod(String settingName, String input,ListView v,PairValue person, menuInfoListAdapter dikzo){
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final View v = inflater.inflate(R.layout.changeperiod, null);
