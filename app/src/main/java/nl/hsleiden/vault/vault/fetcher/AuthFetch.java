...
public class AuthFetch implements Runnable{
    ...
    public AuthFetch(String usernameN, String passwordN, Context context){
        password = passwordN;
        username = usernameN;
        c = context;
    }
    ...
    public static boolean authenticateMe(Context c) {
        ...
        c.getSharedPreferences("userData", 0).edit().putString("voornaam",voornaam).commit();
        c.getSharedPreferences("userData", 0).edit().putString("snr",echtechtId).commit();
