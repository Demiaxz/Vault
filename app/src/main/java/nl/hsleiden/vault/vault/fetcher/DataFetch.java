...
public class DataFetch implements Runnable{
        ...
        public DataFetch(String usernameN, String passwordN, Context context){
            password = passwordN;
            username = usernameN;
            c = context;
        }
        ...
        public void run(){
            ...
            goods = authenticateMe(c);
        }

        public Document runAuth(){
            try {
                run();
                return goods;
            }
        ...
        public static Document authenticateMe(Context c) {
            ...
            try {
                url = new URL("https://studievolg.hsleiden.nl/student/ToonResultaten.do");
            } catch (MalformedURLException e) {
                System.out.println("fourth link not found.");
            }
